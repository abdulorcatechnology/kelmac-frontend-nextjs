      ...
      >
        {rendered.map((src, idx) => (
          <div
            ...
            style={{
              // On mobile: use ~60vw width, clamp to itemWidth on larger screens
              width: `min(${itemWidth}px, 60vw)`,
              // Keep a fixed aspect ratio instead of fixed height
              height: `min(${itemHeight}px, 30vw)`,
            }}
          >
            <Image
              src={src}
