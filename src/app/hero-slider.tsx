    ...
    >
      {[1, 2, 3].map((_, index) => (
        <SwiperSlide key={index}>
          <section className="relative bg-primary bg-[url('/images/bg/hero.png')] bg-cover bg-[-250px_center] md:bg-[300px_center] lg:bg-[350px_center] bg-no-repeat lg:min-h-183 flex flex-col items-start justify-center overflow-hidden rounded-3xl mx-4 md:mx-0">
