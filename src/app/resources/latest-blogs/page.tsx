...
export default function Blogs() {
  ...
  return (
    <main className="main">
      <section className="bg-primary bg-[url('/images/bg/contact.png')] bg-center bg-cover bg-no-repeat lg:min-h-128 flex flex-col items-start justify-center overflow-hidden">
        <div className="main-container primary-py">
          <div className="text-white md:w-[85%] lg:w-[62%]">
            <h1 className="text-2xl md:text-6xl font-hedvig leading-snug">
              Read our latest blogs
            </h1>
            {/* <p className="text-sm text-left md:text-xl font-inter text-capitalize mt-8">
      ...
      <section className="primary-py">
        <div className="main-container flex justify-center">
          <div className="w-full h-[550px] text-white rounded-3xl overflow-hidden bg-cover bg-center bg-no-repeat bg-[url('/images/blog-page-container.png')] flex flex-col justify-end p-8">
            ...
            <h2 className="text-2xl md:text-5xl font-hedvig leading-snug mb-6 md:w-[80%]">
              The Power of Employee Motivation: Boosting Productivity and
              Performance
            </h2>
            <p className="text-base md:text-xl md:w-[80%] mb-8">
              Please take the time to complete the following form and provide us
              with as much information as you are able to ensure we can deal
              with your request as promptly and accurately as we can. We look
            ...
            <div className="flex justify-center items-center gap-2 mt-12 md:mt-16 bg-gray-100 p-4 rounded-xl">
              {Array.from({ length: totalPages }, (_, index) => (
                <button
                  ...
                  className={`w-10 h-10 md:w-12 md:h-12 rounded-lg border border-border text-sm md:text-base font-medium flex items-center justify-center transition-all duration-300 transform hover:scale-105 cursor-pointer ${
                    currentPage === index + 1
              ...
              {totalPages > 2 && (
                <span className="px-1 md:px-2 text-body text-sm md:text-base">
                  ...
                </span>
              )}
              ...
              <button
                ...
                className={`px-3 py-2 md:px-4 md:py-3 rounded-lg border border-border text-sm md:text-base font-medium flex items-center gap-1 md:gap-2 transition-all duration-300 transform ${
