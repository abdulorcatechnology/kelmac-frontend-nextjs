...
export default function OurHistory() {
  return (
    <main className="main">
      <section className="bg-primary md:bg-[url('/images/bg/our-history.png')] bg-cover lg:bg-top md:bg-[70%_top] bg-no-repeat lg:min-h-150 flex flex-col items-start justify-center overflow-hidden md:rounded-3xl">
