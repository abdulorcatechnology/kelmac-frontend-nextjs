...
export const blogItems: BlogPost[] = [
  {
    ...
    postedBy: "John Doe",
    title:
      "Incentivizing Success: Strategies for Rewarding Employee Achievements",
    excerpt: "Food safety is a critical concern in the food industry...",
    content: {
      introduction:
        "In an era where technology and creativity intertwine more intricately than ever, the role of Artificial Intelligence (AI) in the arts has become a pivotal conversation among creators and technologists alike...",
      sections: [
        {
          heading: "The Rise of AI in Creative Fields",
          content:
            "Over the past few years, AI has not only established new standards...",
          list: [
        ...
        },
        {
          ...
          content:
            "For artists and designers, AI serves as both a collaborator and a tool...",
        ...
        },
        {
          heading: "Conclusion",
          content:
            "The fusion of AI and art is not just transforming artistic production...",
        },
      ],
    },
  },

  {
    ...
    content: {
      introduction:
        "In an era where technology and creativity intertwine more intricately  than ever, the role of Artificial Intelligence (AI) in the arts has  become a pivotal conversation among creators and technologists alike. As  AI continues to evolve, it transforms not only how art is made but also  reshapes the very nature of creativity. This blog explores the dynamic  intersection of AI and art, examining its implications, benefits, and  the exciting possibilities ahead.",
      sections: [
        {
          heading: "The Rise of AI in Creative Fields",
          content:
        ...
        },
        {
          heading: "Transforming the Creative Process",
          content:
            "For artists and designers, AI serves as both a collaborator and a tool, offering new ways to engage with their crafts:",
